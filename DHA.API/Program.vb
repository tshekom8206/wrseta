...
Module Program
    ...
    Sub Main()
        ...
        Try
            ...
            Console.WriteLine("  POST /api/dha/verify       - Verify ID with DHA")
            Console.WriteLine("  POST /api/dha/verify-batch - Bulk verification")
            Console.WriteLine("  GET  /api/dha/status       - DHA service status")
            Console.WriteLine("  POST /api/dha/data/add-person - Add person to DB")
            Console.WriteLine("  POST /api/dha/data/add-sample-data - Add sample data")
