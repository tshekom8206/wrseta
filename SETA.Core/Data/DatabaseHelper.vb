...
#Region "SETA Operations"
        ...
        ''' </summary>
        Public Function GetAllSETAs() As List(Of Models.SETA)
            Dim setas As New List(Of Models.SETA)()
            ...
            Using conn As SqlConnection = GetConnection()
                ...
                Using cmd As New SqlCommand("SELECT SETAID, SETACode, SETAName, Sector, IsActive FROM SETAs WHERE IsActive = 1 ORDER BY SETACode", conn)
                    Using reader As SqlDataReader = cmd.ExecuteReader()
                        While reader.Read()
                            setas.Add(New Models.SETA() With {
        ...
        ''' </summary>
        Public Function GetSETAByCode(setaCode As String) As Models.SETA
            Using conn As SqlConnection = GetConnection()
                conn.Open()
