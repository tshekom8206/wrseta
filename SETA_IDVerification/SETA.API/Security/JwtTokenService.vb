...
Namespace Security
    ...
    Public Class JwtTokenService
        ...
        Public Sub New()
            _secretKey = System.Configuration.ConfigurationManager.AppSettings("JwtSecretKey")
            _expirationMinutes = Integer.Parse(System.Configuration.ConfigurationManager.AppSettings("JwtExpirationMinutes"))

            If String.IsNullOrEmpty(_secretKey) OrElse _secretKey.Length < 32 Then
                Throw New System.Configuration.ConfigurationErrorsException("JwtSecretKey must be at least 32 characters")
            End If
        End Sub
